...
function clearCanvas()
{
    ...
    document.getElementById("sketch_confidence").innerHTML = "Confidence: "
    document.getElementById("sketch_should").innerHTML = "Sketch To Be Drawn: " + quick_draw_data_set[Math.floor(Math.random() * quick_draw_data_set.length)]
}
